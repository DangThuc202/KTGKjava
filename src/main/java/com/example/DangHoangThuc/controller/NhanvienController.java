package com.example.DangHoangThuc.controller;

import com.example.DangHoangThuc.entity.nhanvien;
import com.example.DangHoangThuc.service.NhanvienService;
...
import com.example.DangHoangThuc.service.PhongbanService;
...
public class NhanvienController {
    ...
    public String editNVForm(@PathVariable("id") String id, Model model){
        ...
        if(nhanvien != null){
            ...
            model.addAttribute("phongbabn", phongbanService.getAllPhongban());
